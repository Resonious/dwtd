...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'web/pub/dwtd.data';
      var REMOTE_PACKAGE_BASE = 'dwtd.data';
...
Module['FS_createPath']('/assets', 'ui', true, true);
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_web/pub/dwtd.data');

      };
      Module['addRunDependency']('datafile_web/pub/dwtd.data');
   ...
   loadPackage({"files": [{"filename": "/assets/blank.png", "start": 0, "end": 11968, "audio": 0}, {"filename": "/assets/clouds.png", "start": 11968, "end": 13464, "audio": 0}, {"filename": "/assets/clouds.png.info", "start": 13464, "end": 13489, "audio": 0}, {"filename": "/assets/finalmountain.png", "start": 13489, "end": 16796, "audio": 0}, {"filename": "/assets/finalsky.png", "start": 16796, "end": 36976, "audio": 0}, {"filename": "/assets/mountain.png", "start": 36976, "end": 39913, "audio": 0}, {"filename": "/assets/mountaintop.png", "start": 39913, "end": 108944, "audio": 0}, {"filename": "/assets/player.png.info", "start": 108944, "end": 108968, "audio": 0}, {"filename": "/assets/redsky.png", "start": 108968, "end": 140229, "audio": 0}, {"filename": "/assets/sky.png", "start": 140229, "end": 144107, "audio": 0}, {"filename": "/assets/thanksforplaying.png", "start": 144107, "end": 151111, "audio": 0}, {"filename": "/assets/test.txt", "start": 151111, "end": 151131, "audio": 0}, {"filename": "/assets/player/boss.png", "start": 151131, "end": 153843, "audio": 0}, {"filename": "/assets/player/boss_swoosh.png", "start": 153843, "end": 157883, "audio": 0}, {"filename": "/assets/player/bosshorns.png", "start": 157883, "end": 159043, "audio": 0}, {"filename": "/assets/player/horns.png", "start": 159043, "end": 159708, "audio": 0}, {"filename": "/assets/player/horns.png.info", "start": 159708, "end": 159884, "audio": 0}, {"filename": "/assets/player/player.png", "start": 159884, "end": 161082, "audio": 0}, {"filename": "/assets/player/player.png.info", "start": 161082, "end": 161258, "audio": 0}, {"filename": "/assets/player/swoosh.png", "start": 161258, "end": 163485, "audio": 0}, {"filename": "/assets/player/swoosh.png.info", "start": 163485, "end": 163583, "audio": 0}, {"filename": "/assets/player/sword.png", "start": 163583, "end": 164150, "audio": 0}, {"filename": "/assets/player/sword.png.info", "start": 164150, "end": 164326, "audio": 0}, {"filename": "/assets/ui/gridcell.png", "start": 164326, "end": 164842, "audio": 0}], "remote_package_size": 164842, "package_uuid": "24ba574b-a636-404c-a93c-cf9c81ba6cf5"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 72000,
    DYNAMIC_BASE = 5314880,
    DYNAMICTOP_PTR = 71840;
...
var ASM_CONSTS = {
  39940: function($0, $1, $2) {var w = $0; var h = $1; var pixels = $2; if (!Module['SDL2']) Module['SDL2'] = {}; var SDL2 = Module['SDL2']; if (SDL2.ctxCanvas !== Module['canvas']) { SDL2.ctx = Module['createContext'](Module['canvas'], false, true); SDL2.ctxCanvas = Module['canvas']; } if (SDL2.w !== w || SDL2.h !== h || SDL2.imageCtx !== SDL2.ctx) { SDL2.image = SDL2.ctx.createImageData(w, h); SDL2.w = w; SDL2.h = h; SDL2.imageCtx = SDL2.ctx; } var data = SDL2.image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = 0xff; src++; dst += 4; } } else { if (SDL2.data32Data !== data) { SDL2.data32 = new Int32Array(data.buffer); SDL2.data8 = new Uint8Array(data.buffer); } var data32 = SDL2.data32; num = data32.length; data32.set(HEAP32.subarray(src, src + num)); var data8 = SDL2.data8; var i = 3; var j = i + 4*num; if (num % 8 == 0) { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; } } else { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; } } } SDL2.ctx.putImageData(SDL2.image, 0, 0); return 0;},  
 41395: function($0, $1, $2, $3, $4) {var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf;},  
 42384: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 42477: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 43702: function() {return screen.width;},  
 43729: function() {return screen.height;},  
 43802: function($0) {if (typeof Module['setWindowTitle'] !== 'undefined') { Module['setWindowTitle'](UTF8ToString($0)); } return 0;},  
 43956: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 44122: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
 44348: function($0) {if(typeof(Module['SDL2']) === 'undefined') { Module['SDL2'] = {}; } var SDL2 = Module['SDL2']; if (!$0) { SDL2.audio = {}; } else { SDL2.capture = {}; } if (!SDL2.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL2.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL2.audioContext = new webkitAudioContext(); } } return SDL2.audioContext === undefined ? -1 : 0;},  
 44831: function() {var SDL2 = Module['SDL2']; return SDL2.audioContext.sampleRate;},  
 44901: function($0, $1, $2, $3) {var SDL2 = Module['SDL2']; var have_microphone = function(stream) { if (SDL2.capture.silenceTimer !== undefined) { clearTimeout(SDL2.capture.silenceTimer); SDL2.capture.silenceTimer = undefined; } SDL2.capture.mediaStreamNode = SDL2.audioContext.createMediaStreamSource(stream); SDL2.capture.scriptProcessorNode = SDL2.audioContext.createScriptProcessor($1, $0, 1); SDL2.capture.scriptProcessorNode.onaudioprocess = function(audioProcessingEvent) { if ((SDL2 === undefined) || (SDL2.capture === undefined)) { return; } audioProcessingEvent.outputBuffer.getChannelData(0).fill(0.0); SDL2.capture.currentCaptureBuffer = audioProcessingEvent.inputBuffer; dynCall('vi', $2, [$3]); }; SDL2.capture.mediaStreamNode.connect(SDL2.capture.scriptProcessorNode); SDL2.capture.scriptProcessorNode.connect(SDL2.audioContext.destination); SDL2.capture.stream = stream; }; var no_microphone = function(error) { }; SDL2.capture.silenceBuffer = SDL2.audioContext.createBuffer($0, $1, SDL2.audioContext.sampleRate); SDL2.capture.silenceBuffer.getChannelData(0).fill(0.0); var silence_callback = function() { SDL2.capture.currentCaptureBuffer = SDL2.capture.silenceBuffer; dynCall('vi', $2, [$3]); }; SDL2.capture.silenceTimer = setTimeout(silence_callback, ($1 / SDL2.audioContext.sampleRate) * 1000); if ((navigator.mediaDevices !== undefined) && (navigator.mediaDevices.getUserMedia !== undefined)) { navigator.mediaDevices.getUserMedia({ audio: true, video: false }).then(have_microphone).catch(no_microphone); } else if (navigator.webkitGetUserMedia !== undefined) { navigator.webkitGetUserMedia({ audio: true, video: false }, have_microphone, no_microphone); }},  
 46553: function($0, $1, $2, $3) {var SDL2 = Module['SDL2']; SDL2.audio.scriptProcessorNode = SDL2.audioContext['createScriptProcessor']($1, 0, $0); SDL2.audio.scriptProcessorNode['onaudioprocess'] = function (e) { if ((SDL2 === undefined) || (SDL2.audio === undefined)) { return; } SDL2.audio.currentOutputBuffer = e['outputBuffer']; dynCall('vi', $2, [$3]); }; SDL2.audio.scriptProcessorNode['connect'](SDL2.audioContext['destination']);},  
 46963: function($0, $1) {var SDL2 = Module['SDL2']; var numChannels = SDL2.capture.currentCaptureBuffer.numberOfChannels; for (var c = 0; c < numChannels; ++c) { var channelData = SDL2.capture.currentCaptureBuffer.getChannelData(c); if (channelData.length != $1) { throw 'Web Audio capture buffer length mismatch! Destination size: ' + channelData.length + ' samples vs expected ' + $1 + ' samples!'; } if (numChannels == 1) { for (var j = 0; j < $1; ++j) { setValue($0 + (j * 4), channelData[j], 'float'); } } else { for (var j = 0; j < $1; ++j) { setValue($0 + (((j * numChannels) + c) * 4), channelData[j], 'float'); } } }},  
 47568: function($0, $1) {var SDL2 = Module['SDL2']; var numChannels = SDL2.audio.currentOutputBuffer['numberOfChannels']; for (var c = 0; c < numChannels; ++c) { var channelData = SDL2.audio.currentOutputBuffer['getChannelData'](c); if (channelData.length != $1) { throw 'Web Audio output buffer length mismatch! Destination size: ' + channelData.length + ' samples vs expected ' + $1 + ' samples!'; } for (var j = 0; j < $1; ++j) { channelData[j] = HEAPF32[$0 + ((j*numChannels + c) << 2) >> 2]; } }},  
 48048: function($0) {var SDL2 = Module['SDL2']; if ($0) { if (SDL2.capture.silenceTimer !== undefined) { clearTimeout(SDL2.capture.silenceTimer); } if (SDL2.capture.stream !== undefined) { var tracks = SDL2.capture.stream.getAudioTracks(); for (var i = 0; i < tracks.length; i++) { SDL2.capture.stream.removeTrack(tracks[i]); } SDL2.capture.stream = undefined; } if (SDL2.capture.scriptProcessorNode !== undefined) { SDL2.capture.scriptProcessorNode.onaudioprocess = function(audioProcessingEvent) {}; SDL2.capture.scriptProcessorNode.disconnect(); SDL2.capture.scriptProcessorNode = undefined; } if (SDL2.capture.mediaStreamNode !== undefined) { SDL2.capture.mediaStreamNode.disconnect(); SDL2.capture.mediaStreamNode = undefined; } if (SDL2.capture.silenceBuffer !== undefined) { SDL2.capture.silenceBuffer = undefined } SDL2.capture = undefined; } else { if (SDL2.audio.scriptProcessorNode != undefined) { SDL2.audio.scriptProcessorNode.disconnect(); SDL2.audio.scriptProcessorNode = undefined; } SDL2.audio = undefined; } if ((SDL2.audioContext !== undefined) && (SDL2.audio === undefined) && (SDL2.capture === undefined)) { SDL2.audioContext.close(); SDL2.audioContext = undefined; }}
};
...
}function create_audio(pathCstr){ var path = UTF8ToString(pathCstr); var sound = document.createElement('audio'); sound.src = path; sound.id = path; sound.setAttribute('preload', 'auto'); sound.setAttribute('controls', 'none'); sound.style.display = 'none'; document.body.appendChild(sound); return pathCstr; }
function fade_in_music(pathCstr,speed){ var path = UTF8ToString(pathCstr); var music = document.getElementById(path); var currentSong = window.currentSong; if (currentSong != null && currentSong != '') document.getElementById(currentSong).pause(); music.loop = true; music.volume = 0.01; music.currentTime = 0.0; music.play(); window.currentSong = path; var volume = 0.0; var interval = setInterval(() => { if (volume > 1) { music.volume = 1; clearInterval(interval); } else { volume += 0.1; music.volume = volume.toFixed(2); } }, 1000 / speed); }
function fade_out_music(speed){ var currentSong = window.currentSong; if (currentSong == null || currentSong == '') return; var music = document.getElementById(currentSong); var volume = 1.0; var interval = setInterval(() => { if (volume > 0) { volume -= 0.1; music.volume = volume.toFixed(2); } else { clearInterval(interval); window.currentSong = null; music.pause(); } }, 1000 / speed); }
function music_is_playing(){ var currentSong = window.currentSong; if (currentSong == null || currentSong == '') return false; var music = document.getElementById(currentSong); return !music.paused && !music.ended; }
function play_music(pathCstr,loop){ var path = UTF8ToString(pathCstr); var music = document.getElementById(path); var currentSong = window.currentSong; if (currentSong != null && currentSong != '') document.getElementById(currentSong).pause(); music.loop = loop; music.volume = 1; music.currentTime = 0.0; music.play(); window.currentSong = path; }
function play_sound(pathCstr){ var path = UTF8ToString(pathCstr); var sound = document.getElementById(path); sound.loop = false; sound.currentTime = 0; sound.play(); }



// STATICTOP = STATIC_BASE + 70976;
...
var real____em_js__create_audio = asm["__em_js__create_audio"];
asm["__em_js__create_audio"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real____em_js__create_audio.apply(null, arguments);
};

var real____em_js__play_sound = asm["__em_js__play_sound"];
asm["__em_js__play_sound"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real____em_js__play_sound.apply(null, arguments);
};

var real____em_js__play_music = asm["__em_js__play_music"];
asm["__em_js__play_music"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real____em_js__play_music.apply(null, arguments);
};

var real____em_js__fade_out_music = asm["__em_js__fade_out_music"];
asm["__em_js__fade_out_music"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real____em_js__fade_out_music.apply(null, arguments);
};

var real____em_js__fade_in_music = asm["__em_js__fade_in_music"];
asm["__em_js__fade_in_music"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real____em_js__fade_in_music.apply(null, arguments);
};

var real____em_js__music_is_playing = asm["__em_js__music_is_playing"];
asm["__em_js__music_is_playing"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real____em_js__music_is_playing.apply(null, arguments);
};
...
var ___em_js__create_audio = Module["___em_js__create_audio"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__em_js__create_audio"].apply(null, arguments)
};

var ___em_js__play_sound = Module["___em_js__play_sound"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__em_js__play_sound"].apply(null, arguments)
};

var ___em_js__play_music = Module["___em_js__play_music"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__em_js__play_music"].apply(null, arguments)
};

var ___em_js__fade_out_music = Module["___em_js__fade_out_music"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__em_js__fade_out_music"].apply(null, arguments)
};

var ___em_js__fade_in_music = Module["___em_js__fade_in_music"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__em_js__fade_in_music"].apply(null, arguments)
};

var ___em_js__music_is_playing = Module["___em_js__music_is_playing"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__em_js__music_is_playing"].apply(null, arguments)
};
